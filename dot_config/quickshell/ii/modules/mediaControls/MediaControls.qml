...
Scope {
    ...
    readonly property var realPlayers: Mpris.players.values.filter(player => isRealPlayer(player) && player.playbackState !== MprisPlaybackState.Stopped && !isYouTubePreview(player))
